...
UEntityTemplate* ARpgDemoGameMode::CreatePlayerEntityTemplate(FString clientWorkerId,
                                                              const FVector& position, const FVector& rotation)
{
	...
	const auto& spatialOsRotation =
		USpatialOSConversionFunctionLibrary::UnrealCoordinatesToSpatialOsCoordinates(rotation);
	const Coordinates initialRotation{ spatialOsRotation.X, spatialOsRotation.Y, spatialOsRotation.Z };
